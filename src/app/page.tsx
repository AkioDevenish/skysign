              ...
              <p className="text-stone-400 text-sm">
                ...
                <span className="mx-2 inline-flex items-center gap-1.5 px-2 py-0.5 bg-stone-100 rounded-md font-semibold text-stone-700">
                  <svg className="w-4 h-4 text-[#635BFF]" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M13.911 8.012c0-1.073-.839-1.345-1.53-1.345-1.127 0-2.458.455-2.458 1.484 0 .802.637 1.111 1.702 1.345l.654.146c1.182.254 2.801.618 2.801 2.458 0 1.947-1.637 2.729-3.328 2.729-1.329 0-2.924-.4-3.565-1.055l.235-1.345c.545.455 1.764.91 3.129.91 1.254 0 1.837-.473 1.837-1.291 0-.91-.764-1.2-1.782-1.42l-.564-.127c-1.328-.291-2.728-.763-2.728-2.31 0-1.637 1.455-2.673 3.328-2.673 1.182 0 2.383.31 2.892.71l-.22 1.309c-.438-.328-1.547-.691-2.458-.691zm-6.273-1.272v1.345H5.857v5.364c0 .545.436.91.982.91.436 0 .746-.073.964-.182l-.018 1.309c-.31.11-.837.218-1.364.218-1.4 0-2.31-.764-2.31-2.22V8.085h-1.09V6.74h1.09V4.685l1.528-.455V6.74h1.982zm14.127 1.272V14.5h-1.528v-1.127c-.436.727-1.237 1.273-2.31 1.273-1.928 0-3.111-1.473-3.111-3.364 0-2.255 1.4-3.511 3.22-3.511.964 0 1.637.382 2.11.964V8.012h1.619zm-3.074 1.255c-1.018 0-1.764.764-1.764 2.055 0 1.2 1.0 1.981 1.764 1.981.815 0 1.691-.709 1.691-2 .002-1.129-.838-2.036-1.691-2.036zm-10.4 4.51c0-2.255 1.4-3.511 3.22-3.511.964 0 1.637.382 2.11.964V8.012h1.619V14.5H15.11v-1.127c-.436.727-1.237 1.273-2.31 1.273-1.928 0-3.111-1.473-3.111-3.364zm3.037-2.11c-1.018 0-1.764.764-1.764 2.055 0 1.2 1.0 1.981 1.764 1.981.815 0 1.691-.709 1.691-2 .002-1.129-.838-2.036-1.691-2.036z" />
                  </svg>
                  Stripe
                </span>
              </p>
