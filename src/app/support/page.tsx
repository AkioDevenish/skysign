        ...
        <div className="min-h-screen bg-stone-50 text-stone-900">
                ...
                <div className="max-w-6xl mx-auto px-8 lg:px-12 py-5 flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-stone-900 rounded-xl flex items-center justify-center">
                            <svg className="w-5 h-5 text-stone-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <Link href="/" className="text-stone-500 hover:text-stone-900 transition-colors text-sm font-medium">← Back to Home</Link>
                </div>
            </nav>
            ...
            <main className="pt-32 pb-20 px-8 lg:px-12">
                <div className="max-w-2xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold text-stone-900 tracking-tight mb-4">Contact Us</h1>
                    <p className="text-stone-500 text-lg mb-12">Have a question or need help? Send us a message and we&apos;ll get back to you within 24 hours.</p>
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-stone-500">You can also reach us at <a href="mailto:support@skysign.app" className="text-stone-900 underline hover:no-underline">support@skysign.app</a></p>
                    </div>
                </div>
            </main>
